...
class PlayerListener(private val module: ModuleBase, private val campfireManager: CampfireManager) : Listener {
    ...
    private fun onPlayerPlaceCampfire(event: BlockPlaceEvent){
        ...
        campfireManager.registerCampfire(EWCampfire(module, location, blockData, false).create())
    }
}